...
Public Class TrinityDB
    ...
    Public Sub GetVersions()
        ...
        Try
            ...
            sqlDA = New MySqlDataAdapter("SELECT `core_version`, `core_revision`, `db_version`, `script_version`  FROM `version`;", sqlConn)
            sqlCB = New MySqlCommandBuilder(sqlDA)
            ...
            InfoVersion.Script = dtVersions.Rows(0)("script_version").ToString

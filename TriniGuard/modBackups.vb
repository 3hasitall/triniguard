...
Module ModBackups
    ...
    Public Function StartBackup(ByVal strDB As String, ByVal strTB As String) As Boolean
        ...
        If strTB = "" Then
            ...
            Dim mySqlString As String = " --user=" & SqlUser & " --password=" & SqlPass & " --opt " & strDB & " -r " & Convert.ToChar(34) & BackupPath & "\" & strDB & "_" & strTB & "_BACKUP_1" & ".SQL" & Convert.ToChar(34)
        ...
        Else
            ...
            Dim mySqlString = " --user=" & SqlUser & " --password=" & SqlPass & " --add-drop-table " & strDB & " " & strTB & " -r " & Convert.ToChar(34) & BackupPath & "\" & strDB & "_Tables" & "_BACKUP_1" & ".SQL" & Convert.ToChar(34)
            StartProcess(MySqlPath, MySqlFile, mySqlString)
            mySqlString = Nothing
        End If
    ...
    Public Sub CheckDB()
        ...
        Dim mySqlCheckString = " -o -e -A -u" & SqlUser & " -p" & SqlPass
